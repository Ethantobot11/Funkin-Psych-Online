...
class DialogueCharacterEditorState extends MusicBeatState
{
	...
	\nHold Shift to move offsets 10x faster';
		...
		addControl("DIALOGUE_PORTRAIT", "DIALOGUE_PORTRAIT");
	...
	override function update(elapsed:Float) {
		...
		if(!blockInput && !animationDropDown.dropPanel.visible) {
			...
			if(FlxG.keys.justPressed.SPACE || checkControl("A", "justPressed") && UI_mainbox.selected_tab_id == 'Character') {
			...
			if(UI_mainbox.selected_tab_id == 'Animations' && curSelectedAnim != null && character.dialogueAnimations.exists(curSelectedAnim)) {
				...
				var animShit:DialogueAnimArray = character.dialogueAnimations.get(curSelectedAnim);
				var controlArrayLoop:Array<Bool> = [FlxG.keys.justPressed.A || checkControl("LEFT2", "justPressed"), FlxG.keys.justPressed.W || checkControl("UP2", "justPressed"), FlxG.keys.justPressed.D || checkControl("RIGHT2", "justPressed"), FlxG.keys.justPressed.S || checkControl("DOWN2", "justPressed")];
				var controlArrayIdle:Array<Bool> = [FlxG.keys.justPressed.LEFT || checkControl("LEFT", "justPressed"), FlxG.keys.justPressed.UP || checkControl("UP", "justPressed"), FlxG.keys.justPressed.RIGHT || checkControl("RIGHT", "justPressed"), FlxG.keys.justPressed.DOWN || checkControl("DOWN", "justPressed")];
			...
			if(FlxG.keys.justPressed.H || checkControl("Y", "justPressed")) {
			...
			if(FlxG.keys.justPressed.R || checkControl("X", "justPressed")) {
				camGame.zoom = 1;
			...
			if(FlxG.keys.justPressed.ESCAPE #if android || FlxG.android.justPressed.BACK #end || checkControl("B", "justPressed")) {
