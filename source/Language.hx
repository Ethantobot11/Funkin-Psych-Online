...
class Language {
	public static var turkishTexts:Map<String, String> = [
		...
		"Post a Comment Now"    => "Yorum Paylaş",
		...
		"FUNK THEIR BRAINS OUT BOYFRIEND" => "AKILLARINI BAŞLARINDAN AL BOYFRIEND",
