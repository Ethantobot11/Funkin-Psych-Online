...
class Note extends FlxSprite
{
	...
	public function reloadNote(texture:String = '', postfix:String = '') {
		...
		if(customSkin == _lastValidChecked || Paths.fileExists('images/' + path + customSkin + '.png', IMAGE) || Paths.fileExists('images/' + path + customSkin + '.astc', BINARY) || Paths.fileExists('images/' + path + customSkin + '.dds', BINARY))
		{
			skin = customSkin;
